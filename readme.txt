...
The **Gesture Engagement pack** from **errnio** adds a new engagement layer to your site with a simple addition of a plugin. The plugin enables several gesture based actions to be added to any mobile browsing session. This tool enhances user experience, engaging your visitors with your content on mobile. errnio can increase your pages per visit, time spent on site, and improve your over site engagement on mobile. 
...
* **Scroll** - When users scroll your up or down page, we display recommended articles from your site to help increase site navigation. We do this by determining when they are done reading the articles, or are about to exit. Coming soon.
* **Swipe** - Left and right finger actions enable easy browsing of your site content, through a mobile friendly article gallery which promoted your site content. 
* **Tap** - Text selection actions, using the long tap gesture, trigger more information about the selected text, along with additional options to browse related content and search for relevant information. 
* **Zoom** - Zoom actions on your mobile site are enhanced with our zoom tool, which enable users to zoom images without distorting your site experience, and recommending other images in your article and site, along with added social features. Coming soon.
...
1. Swipy - Generating a gallery of your content or articles, easily accessible from the right hand of the screen, triggered by a swipe action of your finger on the screen.
2. Tappy - Offering added content and actions on your long tap gesture, when selecting text on the page.
3. Scrolly (coming soon) - Reacting to scroll and offering content, search and navigation options.
4. Zoomy (coming soon) - Enabling a better zoom experience on mobile for your site images.
